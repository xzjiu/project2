...
function App() {
  ...
  return (
    <Container fluid>
        <header className="masthead" style={{zIndex:"1", backgroundImage: "url('https://images.pexels.com/photos/1631677/pexels-photo-1631677.jpeg')"}}>
            <div classNameName="container-fluid position-relative px-4 px-lg-5">
                <div className="row gx-4 gx-lg-5 justify-content-center">
                    <div className="col-md-11 col-lg-9 col-xl-8">
                        <div className="post-heading" style={{zIndex:"2"}}>
                            ...
                            <span className="meta">
                                Posted by
                                <a href="#!"> Xinrui Zou, Rishi Jain, Matt Liu, Taylor Young</a>
                            </span>
                        </div>
                    </div>
                </div>
